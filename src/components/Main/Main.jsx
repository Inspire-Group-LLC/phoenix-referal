                ...
                <div className="content">
                    <div className="row">
                        ...
                        <div className="lil-btns-mobile mobile-col">
                            ...
                            <SmallBtn onClick={()=>navigation(APP_ROUTES.MONITORING)}>
                                Мониторинг {15}
                            ...
                            <SmallBtn onClick={()=>navigation(APP_ROUTES.REFERENCES)}>
                                <p>Ссылки   {16}</p>
                                <svg width="26" height="25" viewBox="0 0 26 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="big-btns">
                            <BigBtn style={{ cursor: 'pointer' }} className='big-btn' onClick={() => navigation(APP_ROUTES.MONITORING)} >
                            ...
                            <BigBtn style={{ cursor: 'pointer' }} onClick={() => setModal(true)}>

                                <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M25 50C38.8071 50 50 38.8071 50 25C50 11.1929 38.8071 0 25 0C11.1929 0 0 11.1929 0 25C0 38.8071 11.1929 50 25 50ZM25 15.25C25.5523 15.25 26 15.6977 26 16.25V24H24V16.25C24 15.6977 24.4477 15.25 25 15.25ZM24 26V24H16.25C15.6977 24 15.25 24.4477 15.25 25C15.25 25.5523 15.6977 26 16.25 26H24ZM26 26V24H33.75C34.3023 24 34.75 24.4477 34.75 25C34.75 25.5523 34.3023 26 33.75 26H26ZM26 26H24V33.75C24 34.3023 24.4477 34.75 25 34.75C25.5523 34.75 26 34.3023 26 33.75V26Z" fill="white" />
                                </svg>
                                <p>
                                    Создать ссылку
                                </p>
